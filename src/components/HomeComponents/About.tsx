...
const About = () => {
  return (
    <section className="flex justify-center w-full ">
      <div className="aboutLeft  w-1/2 text-3xl ">
        <h3 className="w-4/6 font-medium my-4">
          Empowering you to Organize, Achieve and Thrive Everyday.
        </h3>
        <div className="cards w-full border flex ">
          <Card
            title="Note Taking"
      ...
      <div className="aboutRight w-1/4 bg-gradient-to-r from-[#FCD9DF] to-[#CFE0F8]  my-4 mx-2  p-8 rounded-3xl ">
